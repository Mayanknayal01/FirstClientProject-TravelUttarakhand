...
import { itinerary_elements } from '../../../Assets/Assets.js';


const TreksIitneraryComponent = ({id, banner, name, heading, mainImage, duration, difficulty, altitude, distance, transportation, meals, season, type, overview, toggle_heading, days_detail, highlights 
}) => {
            ...
            <div className="itinerary_first">
                ...
                <div className="itinerary_grid">
                    ...
                    <div className="itinerary_pic">
                        <img src={mainImage} alt="trek name" />
                    </div>
                </div>
            </div>
...
export default TreksIitneraryComponent;