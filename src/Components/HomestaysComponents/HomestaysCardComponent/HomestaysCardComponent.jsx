...
const HomestaysCardComponent = ({id, homestay_name,rating, remark, reviews, real_price, discounted_price, image, location, availability}) => {
    return (
...
export default HomestaysCardComponent;