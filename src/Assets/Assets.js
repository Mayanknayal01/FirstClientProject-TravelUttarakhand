...
export const itinerary_items = [
  {
    ...
    heading:
      "One of India's best Winter Treks with a breathtaking 360° view of the Himalayan range",
    duration: "4N/5D",
    ...
    type: "Solo/Group",
    overview:
      "Get ready for an unforgettable adventure on the Kedarkantha trek! Walk through snow-covered trails, pass by Juda Ka Tal, the frozen lake, and witness stunning sunrise views from the summit. Surrounded by majestic Himalayan peaks, this thrilling winter trek promises excitement and breathtaking beauty at every step.",
    ...
    highlights:
      "Kedarkantha is a wonderful trek, with pretty campsites and stunning 360-degree views of mountain summits."
  }
];
